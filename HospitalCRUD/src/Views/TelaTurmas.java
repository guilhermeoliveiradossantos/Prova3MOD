...
public class TelaTurmas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblTurmas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Numero Turma", "Prof Resp", "Ano letivo", "Codigo Turma","Horario de aula"
            }
        ));
    ...
    private void cadastroTurmas() {
        ...
        String numeroTurma = txtIDT.getText();
        String profR = txtProfessorR.getText();
        String AnoL = txtAno.getText();
        String CT = txtCT.getText();
        String HoraT = txtHorT.getText();

        if (numeroTurma.isEmpty() && profR.isEmpty() && AnoL.isEmpty() && CT.isEmpty() && HoraT.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Preencha todos os campos");
        } else {

            tm.setNumeroTurma(NORMAL);
    ...
    private void ListarTurmas() {
        ...
        try {
            ...
            System.out.println("erro em mostrar Turmas: " + e);
