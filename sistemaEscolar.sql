...
CREATE TABLE Turmas (
    numeroTurma int primary key auto_increment not null,
...
INSERT INTO Alunos (ID, Nome, DataNascimento, Email, Telefone, Endereco, Turma)
VALUES 
(1, 'João Silva', '2005-06-12', 'joaosilva@email.com', '(27) 12345-6789', 'Rua das Flores, 123, Vitória, ES', 101),
(2, 'Maria Santos', '2006-07-23', 'mariasantos@email.com', '(27) 98765-4321', 'Avenida do Sol, 456, Vitória, ES', 102),
(3, 'Pedro Costa', '2005-08-30', 'pedrocosta@email.com', '(27) 54321-6789', 'Praça da Lua, 789, Vitória, ES', 101);
